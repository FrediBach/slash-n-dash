...
describe('Lodash Extended Methods', () => {
  ...
  test('resolveWildcardPath', () => {
    ...
    expect(_.resolveWildcardPath(testObject, 'a.**')).toEqual(['a.b.c', 'a.b.d', 'a.e.0', 'a.e.1', 'a.e.2', 'a.f']);
    expect(_.resolveWildcardPath(testObject, 'a.e.*')).toEqual(['a.e.0', 'a.e.1', 'a.e.2']);
  });
  ...
  test('appendStringByPath', () => {
    ...
    expect(() => _.appendStringByPath(testObject, 'a.b.c', ' appended')).toThrow();
  });
  ...
  test('filterObjectByPath', () => {
    _.filterObjectByPath(testObject, 'a.b', (value) => typeof value === 'string');
    expect(testObject.a.b).toEqual({ d: 'test' });
  });

  test('mapObjectByPath', () => {
    _.mapObjectByPath(testObject, 'a.b', (value) => typeof value === 'number' ? value * 2 : value);
  ...
  test('deepFreezeByPath', () => {
    ...
    expect(() => { testObject.a.b.c = 2; }).toThrow();
  });
  ...
  test('sortObjectValuesByPath', () => {
    ...
    expect(Object.values(testObject.a.b)).toEqual([1, 2, 'test']);
  });
